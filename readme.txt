...
This plugin converts the WooCommerce store into a multi-vendor store like Amazon, eBay and Etsy. Sellers can manage their inventory, profile page, collection page, and much more.
...
=== MULTI-VENDOR MARKETPLACE LITE FOR WOOCOMMERCE FEATURES ===

[Lite Module blog](https://webkul.com/blog/marketplace-for-woocommerce-lite/)
...
Only 5 sellers are allowed to register in Multi-Vendor Marketplace Lite for WooCommerce module. For unlimited seller registration consider upgrading to [Pro](https://store.webkul.com/woocommerce-multivendor-marketplace.html)
...
Customers can see the seller name on product single page, cart, checkout and thank you page.
Can add products from different sellers to cart.
...
== [Pro features](https://store.webkul.com/woocommerce-multivendor-marketplace.html): ==
...
To see list of 50+ Pro Addons [Click Here](https://store.webkul.com/woocommerce-plugins/Marketplace.html)
...
3. Configure and setup the plugin through 'Marketplace' admin menu.

For detailed blog and tutorials visit our [Pro Module Blog page](https://webkul.com/blog/wordpress-woocommerce-marketplace/).
...
Ans: Yes, the buyer can purchase products from different sellers by merely adding the products to the cart and then proceeding to checkout.
...
5. **Google Analytics & Map:** - Configuration for Google Analytics and Map on seller dashboard.
