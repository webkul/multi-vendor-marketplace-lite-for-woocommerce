...
$seller_order   = is_array( $data ) ? wc_get_order( $data[0]->get_order_id() ) : wc_get_order( $data->get_order_id() ); //phpcs:ignore WordPress.WP.GlobalVariablesOverride.Prohibited
