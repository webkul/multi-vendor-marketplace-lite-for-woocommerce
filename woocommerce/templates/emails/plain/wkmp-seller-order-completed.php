...
echo wp_sprintf( /* translators: %s: Login URL. */ esc_html__( 'Hi %s,', 'wk-marketplace' ), esc_attr( mb_convert_encoding( $loginurl, 'UTF-8' ) ) ) . "\n\n";

$result = esc_html__( 'We have finished processing your order.', 'wk-marketplace' ) . '&nbsp;' . mb_convert_encoding( $seller_order->get_formatted_billing_full_name(), 'UTF-8' ) . "\n\n" . 'Order #' . $seller_order->get_ID() . ' (' . $date_string . ') ' . "\n\n";
