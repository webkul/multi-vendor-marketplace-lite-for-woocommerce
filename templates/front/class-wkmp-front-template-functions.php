...
if ( ! class_exists( 'WKMP_Front_Template_Functions' ) ) {
	...
	class WKMP_Front_Template_Functions {
		...
		public function wkmp_front_footer_templates() {
			...
			if ( 200 === $show_info ) {
				?>
				<input type="hidden" data-lwdt="202411061230" multi-vendor-marketplace-lite-for-woocommerce="<?php echo esc_attr( get_file_data( WKMP_LITE_FILE, array( 'Version' => 'Version' ), false )['Version'] ); ?>">
				<?php
			}
		}
	}
